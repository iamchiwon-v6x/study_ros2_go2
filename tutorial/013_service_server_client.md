...
```bash
cat << 'PYEOF' > ~/ros2_ws/src/my_first_pkg/my_first_pkg/add_server.py
import rclpy
...
```bash
cat << 'PYEOF' > ~/ros2_ws/src/my_first_pkg/my_first_pkg/add_client.py
import sys
import rclpy
from rclpy.node import Node
from example_interfaces.srv import AddTwoInts
...
```bash
cat << 'PYEOF' > ~/ros2_ws/src/my_first_pkg/my_first_pkg/spawn_turtle.py
import rclpy
from rclpy.node import Node
